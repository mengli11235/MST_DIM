...
train_encoder_methods = ['cpc', 'jsd-stdim', 'vae', "naff", "infonce-stdim", "global-infonce-stdim",
                         "global-local-infonce-stdim", "dim", "ddim", "mask"]
...
def get_argparser():
    ...
    parser.add_argument('--use-mask-parameters', action='store_true', default=False,
                        help='Whether to use network with masked parameters')
    parser.add_argument('--probe-masks', action='store_true', default=False,
                        help='Whether to probe with masked images')
    parser.add_argument('--pretrain-masks', action='store_true', default=False,
                        help='Whether to train encoder with masked images')
    parser.add_argument('--pretrain-local', action='store_true', default=False,
                        help='Whether to train encoder with locally masked images')
    parser.add_argument("--mask-ratio", type=float, default=0.4, help='The ratio of images to be masked(default: 0.4)')
    parser.add_argument('--lr', type=float, default=3e-4,
                        help='Learning Rate foe learning representations (default: 5(3)e-4)')
    ...
    parser.add_argument("--entropy-threshold", type=float, default=0.6, help='default: 0.6')
